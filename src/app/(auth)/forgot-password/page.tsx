...
function ForgotPasswordPageInner() {
  ...
  // /auth/callback bounces expired or already-consumed recovery links
  // back here with this flag, so we can say what went wrong instead of
  // showing a bare form the user has no reason to trust.
